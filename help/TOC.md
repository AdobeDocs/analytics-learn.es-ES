...
+ Introducción a Analytics {#intro-to-analytics}
   + ¿Qué Puede Hacer Adobe Analytics Por Mí? {#what-can-aa-do-for-me}
      ...
      + [Cumbre 2019 Super Sesión - Venta al detalle](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-retail.md)
      + [Supersesión de la Cumbre 2019 - Alta tecnología](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-high-tech.md)
   + Aspectos básicos de Analytics {#analytics-basics}
      + [Botón Probar en el espacio de trabajo en Reports and Analytics](intro-to-analytics/analytics-basics/try-in-workspace-button.md)
   ...
   + Obtención de ayuda {#getting-help}
      + [Consejos sobre el producto de Analysis Workspace](intro-to-analytics/getting-help/in-product-tips.md)
      + [Envío de entradas de asistencia técnica dentro del producto](intro-to-analytics/getting-help/in-product-support-ticket-submission.md)
...
+ Analysis Workspace {#analysis-workspace}
   + Conceptos básicos de Analysis Workspace {#analysis-workspace-basics}
      ...
      + [Uso de plantillas personalizadas para activar el acceso de los usuarios de Analysis Workspace a la clientela](analysis-workspace/analysis-workspace-basics/using-custom-templates-to-enable-novice-users.md)
   ...
   + Pestaña Sugerencias y trucos {#tips-and-tricks}
      ...
      + [Consejos del cliente para continuar con el Recorrido de aprendizaje de Adobe Analytics](analysis-workspace/tips-and-tricks/customer-tips-for-continuing-your-adobe-analytics-learning-journey.md)
   + Navegación de proyectos de Workspace {#navigating-workspace-projects}
      ...
      + [Densidad de vista en Analysis Workspace](analysis-workspace/navigating-workspace-projects/view-density-in-analysis-workspace.md)
      + [Mejoras de estado cero](analysis-workspace/navigating-workspace-projects/zero-state-improvements.md)
      + [Uso de Filtros (etiquetas) en el raíl izquierdo](analysis-workspace/navigating-workspace-projects/using-filters-tags-in-the-left-rail.md)
   ...
   + Creación de tablas improvisadas {#building-freeform-tables}
      ...
      + [Continúe haciendo clic con el botón derecho en el menú de Analysis Workspace](analysis-workspace/building-freeform-tables/continued-right-click-menu-in-analysis-workspace.md)
      ...
      + [Dimension de partición de tiempo en Analysis Workspace](analysis-workspace/building-freeform-tables/time-parting-dimensions-in-analysis-workspace.md)
      + [Totales de tabla improvisada en Analysis Workspace](analysis-workspace/building-freeform-tables/freeform-table-totals-in-analysis-workspace.md)
   + Visualizaciones {#visualizations}
      ...
      + [Visualizaciones de cambio de resumen y número de resumen](analysis-workspace/visualizations/summary-number-and-summary-change-visualizations.md)
      ...
      + [Vinculación en vivo de Dimension-gráfico](analysis-workspace/visualizations/dimension-graph-live-linking.md)
      + [Alternar granularidad](analysis-workspace/visualizations/granularity-toggle.md)
   ...
   + Aplicación de segmentos {#applying-segments}
      ...
      + [Segmentos de nivel de panel](analysis-workspace/using-panels/panel-level-segments.md)
      + [Mejoras en la zona de colocación de segmentos](analysis-workspace/using-panels/segment-dropzone-improvements.md)
      + [Uso de segmentos como Dimension en Analysis Workspace](analysis-workspace/applying-segments/using-segments-as-dimensions-in-analysis-workspace.md)
...
+ Reports and Analytics {#reports-and-analytics}
   + [Sistema de informes en tiempo real en Reports and Analytics](reports-and-analytics/realtime-reporting-in-reports-and-analytics.md)
+ Administración {#administration}
   ...
   + Registros{#logs}
      + [Seguimiento de registro de uso para Analysis Workspace](administration/logs/usage-log-tracking-for-analysis-workspace.md)
+ Implementación {#implementation}
   ...
   + Mediante el Experience Platform Launch {#via-adobe-launch}
      ...
      + [Configuración general en Launch Analytics Extension](implementation/via-adobe-launch/configuring-general-settings-in-the-launch-analytics-extension.md)
      ...
      + [Configuración de cookies en Launch Analytics Extension](implementation/via-adobe-launch/configuring-cookie-settings-in-the-launch-analytics-extension.md)
      ...
      + [Uso de una capa de datos para establecer el nombre de la página y otras variables mediante el lanzamiento](implementation/via-adobe-launch/using-a-data-layer-to-set-page-name-and-other-variables-via-launch.md)
      ...
      + [Uso de doPlugins en Adobe Analytics Extension](implementation/via-adobe-launch/use-doplugins-in-the-adobe-analytics-extension.md)
      ...
      + [Configuración del seguimiento de vínculos de salida sencilla](implementation/via-adobe-launch/configuring-easy-exit-link-tracking.md)
      + [Preparación del Experience Platform Launch para la implementación de Analytics](implementation/via-adobe-launch/preparing-adobe-launch-for-your-analytics-implementation.md)
      ...
      + [Creación de una regla de página global en el Experience Platform Launch](implementation/via-adobe-launch/creating-a-global-page-rule-in-launch.md)
      ...
      + [Creación de reglas Experience Platform Launch para Eventos de éxito](implementation/via-adobe-launch/creating-launch-rules-for-success-events.md)
      + [Publicación de bibliotecas Experience Platform Launch en el escenario y la producción](implementation/via-adobe-launch/publishing-launch-libraries-to-stage-and-production.md)
...
+ Componentes {#components}
   + Segmentación {#segmentation}
      ...
      + [Segmentación en recuentos de Dimension distintos](components/segmentation/segmentation-on-distinct-dimension-counts.md)
   ...
   + Métricas calculadas {#calculated-metrics}
      ...
      + [Uso de Dimension en métricas calculadas](components/calculated-metrics/using-dimensions-in-calculated-metrics.md)
...
+ Herramientas adicionales {#additional-tools}
   + Paneles de Analytics {#analytics-dashboards}
      ...
      + [Experiencia en la aplicación de paneles de Analytics](additional-tools/analytics-dashboards/adobe-analytics-dashboards-in-app-experience.md)
+ Exportando {#exporting}
   + Desde la interfaz de usuario {#from-the-ui}
      + [Exportar a CSV desde Analysis Workspace](exporting/from-the-ui/export-to-csv-from-analysis-workspace.md)
   + Data Warehouse {#data-warehouse}
      + [Introducción a la Data Warehouse](exporting/data-warehouse/introduction-to-data-warehouse.md)
   ...
   + Report Builder {#report-builder}
      + [Añadir segmentos a varias solicitudes a la vez en Report Builder](exporting/report-builder/add-segments-to-multiple-requests-at-once-in-report-builder.md)
      + [Detección de anomalías en el Report Builder](exporting/report-builder/anomaly-detection-in-report-builder.md)
...
+ Integraciones {#integrations}
   ...
   + Audience Manager {#audience-manager}
      + [Habilitar reenvío de servidor en Experience Platform Launch](integrations/audience-manager/enable-server-side-forwarding-in-adobe-launch.md)
      + [Audience Analytics: Integrar segmentos de AAM en Analytics](integrations/audience-manager/audience-analytics-integrate-aam-segments-into-analytics.md)
   + Target {#target}
...
+ Específico vertical {#vertical-specific}
   ...
   + Comercial {#retail}
      ...
      + [Añadir variables y Eventos comerciales básicos para iniciar reglas](vertical-specific/retail/adding-basic-retail-variables-and-events-to-launch-rules.md)
      + [Añadir una regla de inicio para el Evento de compra](vertical-specific/retail/adding-a-launch-rule-for-the-purchase-event.md)
      + [Cumbre 2019 Super Sesión - Venta al detalle](intro-to-analytics/what-can-aa-do-for-me/adobe-summit-2019-super-session-retail.md)
...
+ Análisis de aplicaciones móviles {#mobile-app-analytics}
   + Implementación {#implementation}
      ...
      + [Estado de seguimiento (AKA Pages or Screens)](mobile-app-analytics/implementation/tracking-state-aka-pages-or-screens.md)
