...
Según [Adobe](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/attribution/overview.html?lang=en), *atribución* permite a los analistas personalizar el modo *Dimension* los elementos reciben crédito por *eventos de éxito*.


**⛔** Solo una nota rápida para decir eso **modelos de atribución** se asocian con tanta frecuencia con **canales de marketing** que yo a propósito *tachado* CANAL en la imagen de arriba para ilustrar que es posible realizar **atribución** análisis frente a casi cualquier otro ***dimensión***.
...
Teniendo esto en cuenta, aquí hay algunos ejemplos de cómo la **modelos de atribución** podría afectar a esos **10 personas**:
...
Ahora que ha visto lo que puede hacer, no se deje engañar ni intimidar por las características aparentemente complejas del panel de atribución.  **Afróntalo.**.  *Abrazo* it.  Comprenderlo*.* PERO SOBRE TODO - *Úsalo a tu favor.* El **panel de atribución** y **ventana retrospectiva** son la clave para comprender mejor a sus clientes y su recorrido con su marca.

Ahora, podemos viajar &quot;[atrás en el tiempo](https://youtu.be/gVryJmZNFdU)&quot; con confianza y usar el poder de nuestra máquina del tiempo confiable (también conocida como, ***Adobe Analytics***) para tomar decisiones basadas en datos.
